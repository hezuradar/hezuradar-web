(function () {
  ...
  const PICK_SILHOUETTE = [
    [0.5521, 0.0229], [0.8466, 0.0857], [0.9515, 0.1714], [0.9884, 0.2571],
    [0.9966, 0.3429], [0.9838, 0.4286], [0.9545, 0.5143], [0.9151, 0.6],
    [0.8641, 0.6857], [0.8013, 0.7714], [0.7269, 0.8571], [0.6279, 0.9429],
    [0.504, 0.9771], [0.3738, 0.9143], [0.27, 0.8286], [0.1881, 0.7429],
    [0.1237, 0.6571], [0.0733, 0.5714], [0.0358, 0.4857], [0.0118, 0.4],
    [0.0051, 0.3143], [0.0219, 0.2286], [0.0753, 0.1429], [0.2297, 0.0571],
  ];
